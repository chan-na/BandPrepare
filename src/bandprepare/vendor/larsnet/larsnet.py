# Vendored from LarsNet (https://github.com/polimi-ispl/larsnet),
# by A. I. Mezza, R. Giampiccolo, A. Bernardini, A. Sarti.
# Paper: "Toward Deep Drum Source Separation", Pattern Recognition Letters (2024),
